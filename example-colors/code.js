            ...
            if (motionController.handness === 'left') {
                ...
                triggerComponent.onButtonStateChangedObservable.add(() => {
                    if (triggerComponent.pressed) {
                        ...
                        Box_Left_Trigger.material = new BABYLON.StandardMaterial("Box_Left_Trigger_Red", scene);
                        Box_Left_Trigger.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                squeezeComponent.onButtonStateChangedObservable.add(() => {
                    if (squeezeComponent.pressed) {
                        ...
                        Box_Left_Squeeze.material = new BABYLON.StandardMaterial("Box_Left_Squeeze_Red", scene);
                        Box_Left_Squeeze.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                thumbstickComponent.onButtonStateChangedObservable.add(() => {
                    if (thumbstickComponent.pressed) {
                        ...
                        Box_Left_ThumbStick.material = new BABYLON.StandardMaterial("Box_Left_ThumbStick_Red", scene);
                        Box_Left_ThumbStick.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                xbuttonComponent.onButtonStateChangedObservable.add(() => {
                    if (xbuttonComponent.pressed) {
                        ...
                        Sphere_Left_XButton.material = new BABYLON.StandardMaterial("Sphere_Left_XButton_Red", scene);
                        Sphere_Left_XButton.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                ybuttonComponent.onButtonStateChangedObservable.add(() => {
                    if (ybuttonComponent.pressed) {
                        ...
                        Sphere_Left_YButton.material = new BABYLON.StandardMaterial("Sphere_Left_YButton_Red", scene);
                        Sphere_Left_YButton.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
            ...
            if (motionController.handness === 'right') {
                ...
                triggerComponent.onButtonStateChangedObservable.add(() => {
                    if (triggerComponent.pressed) {
                        ...
                        Box_Right_Trigger.material = new BABYLON.StandardMaterial("Box_Right_Trigger_Blue", scene);
                        Box_Right_Trigger.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                squeezeComponent.onButtonStateChangedObservable.add(() => {
                    if (squeezeComponent.pressed) {
                        ...
                        Box_Right_Squeeze.material = new BABYLON.StandardMaterial("Box_Right_Squeeze_Blue", scene);
                        Box_Right_Squeeze.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                thumbstickComponent.onButtonStateChangedObservable.add(() => {
                    if (thumbstickComponent.pressed) {
                        ...
                        Box_Right_ThumbStick.material = new BABYLON.StandardMaterial("Box_Right_ThumbStick_Blue", scene);
                        Box_Right_ThumbStick.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                abuttonComponent.onButtonStateChangedObservable.add(() => {
                    if (abuttonComponent.pressed) {
                        ...
                        Sphere_Right_AButton.material = new BABYLON.StandardMaterial("Sphere_Right_AButton_Blue", scene);
                        Sphere_Right_AButton.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
                ...
                bbuttonComponent.onButtonStateChangedObservable.add(() => {
                    if (bbuttonComponent.pressed) {
                        ...
                        Sphere_Right_BButton.material = new BABYLON.StandardMaterial("Sphere_Right_BButton_Blue", scene);
                        Sphere_Right_BButton.material.diffuseColor = new BABYLON.Color3(Math.random(), Math.random(), Math.random());
